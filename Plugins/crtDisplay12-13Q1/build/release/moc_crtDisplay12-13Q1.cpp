/****************************************************************************
** Meta object code from reading C++ file 'crtDisplay12-13Q1.h'
**
...
#error "The header file 'crtDisplay12-13Q1.h' doesn't include <QObject>."
...
const QMetaObject CrtDisplay::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CrtDisplay.data,
      qt_meta_data_CrtDisplay,  qt_static_metacall, nullptr, nullptr}
};
...
void *CrtDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "BasicPlugin"))
        return static_cast< BasicPlugin*>(const_cast< CrtDisplay*>(this));
...
QT_MOC_EXPORT_PLUGIN(CrtDisplay, CrtDisplay)
